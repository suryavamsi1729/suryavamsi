    ...
    return (
        <section ref={scopeRef} id="About-myself" className='relative w-full min-h-screen mt-[100vh]'>
            <div id="images section" className="w-full h-auto flex flex-row justify-center items-center gap-16">
                <img src="/images/optimized/suryavamsi.avif" alt="SuryaVamsiImage" className="w-[156px] h-[195px] md:w-[254px] md:h-[316px] lg:w-[344px] lg:h-[430px] object-bottom object-cover z-[1000] rounded"/>
            </div>
